...
var Candidato = /** @class */ (function (_super) {
    __extends(Candidato, _super);
    function Candidato() {
    ...
    __decorate([
        ...
        __metadata("design:type", Number)
    ], Candidato.prototype, "votos", void 0);
    __decorate([
        typeorm_1.ManyToOne(function () { return Cidade_1.default; }, function (cidade) { return cidade.candidatos; }),
